...
import { User, LogOut, Shield, Home as HomeIcon, LogIn, UserPlus, Inbox, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center gap-4">
                            {user ? (
                                <>
                                    <Button variant="secondary" size="sm" className="gap-2" onClick={() => navigate('/inbox')}>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="text-center mb-12">
                    <p className="text-sm uppercase tracking-[0.3em] text-muted-foreground mb-3">Secure email sandbox</p>
                    <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 bg-clip-text text-transparent">
                        {user ? `Welcome back, ${user.email.split('@')[0]}!` : 'Authenticate. Refresh. Collaborate.'}
                    </h2>
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        End-to-end token handling, Google Sign-In, and a polished tri-pane inbox mockup. Everything you need
                        to demonstrate a production-ready auth flow.
                    </p>
                    {!user && (
                    ...
                    <>
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                            <Card className="border-primary/40 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <CardContent className="space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm capitalize">{user.provider ?? 'password'}</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-green-500/40 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <CardContent className="space-y-2">
                                    <p className="text-sm text-muted-foreground">
                                        Access tokens live in-memory; refresh tokens stay in hardened storage. Automatic rotation covers
                                        expiry + concurrency.
                                    </p>
                            ...
                            <Card className="border-blue-500/40 shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <CardContent className="space-y-2">
                                    <p className="text-sm text-muted-foreground">
                                        Browse folders, paginate messages, preview details, and interact with mocked attachments and actions.
                                    </p>
                                    <Button size="sm" className="gap-2" onClick={() => navigate('/inbox')}>
                    ...
                    <>
                        <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto mb-12">
                            <Link to="/login">
                                <Card className="border-blue-500/50 shadow-lg hover:shadow-xl transition-all cursor-pointer h-full">
                                    ...
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground">
                                            Access protected inbox routes, trigger refresh tokens, and explore the post-login workspace.
                                        </p>
                                    </CardContent>
                                </Card>
                            </Link>
                            ...
                            <Link to="/signup">
                                <Card className="border-green-500/50 shadow-lg hover:shadow-xl transition-all cursor-pointer h-full">
                                    ...
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground">
                                            Register with validation, then hop into the secure inbox. Google Sign-In is supported on login.
                                        </p>
                                    </CardContent>
                                </Card>
                            </Link>
                        ...
                        <div className="grid gap-6 md:grid-cols-3 max-w-6xl mx-auto">
                            <Card className="shadow-md hover:shadow-lg transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Short-lived access tokens + rotating refresh tokens with forced logout when anything goes stale.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="shadow-md hover:shadow-lg transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Fully mocked folders, email list pagination, and detailed message bodies with attachments.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="shadow-md hover:shadow-lg transition-shadow">
                                ...
                                <CardContent>
                                    <p className="text-sm text-muted-foreground">
                                        Desktop tri-pane layout collapses gracefully on mobile with keyboard-friendly navigation.
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
